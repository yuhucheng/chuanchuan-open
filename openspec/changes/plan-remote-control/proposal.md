...
[两仓开发计划 v0.1.0](../../../docs/superpowers/plans/2026-09-15-cross-repository-development.md)统一本 change 的执行次序：**U / M 之后，未排期**。协作对象：closed:plan-remote-control-engine。本仓交付：控制授权交互、公开输入契约与控制端状态。需求条款与 spec-version 保持不变；本次同步仅更新规划，不勾选实施任务。
